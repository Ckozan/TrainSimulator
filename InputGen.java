...
public class InputGen {
	...
	public static String buildRepeatableRoutes() {
		...
		builder.append(buildPassengerRoutes(10));
	...
	public static String buildPassengerRoutes(int numOfPassengerRoutes) {
		StringBuilder builder = new StringBuilder();
		String station;
		String arrivalTime;
		builder.append("C PASSENGER ");
		for (int i = 0; i < 4 - getDigits(numOfPassengerRoutes); i++)
			builder.append('0');
		builder.append(numOfPassengerRoutes + "\n");
		for (int i = 0; i < numOfPassengerRoutes; i++) {
			int amtOfRoutes = ((int) (Math.random() * 10));
			builder.append("C ROUTE " + amtOfRoutes + " " + ((int) (Math.random() * 100) < 25 ? "F" : "W") + "\n");
	...
	public static String buildStructureTrailer(StringBuilder b) {
		...
		builder.append(numOfNonControls + "-1 ");

		if (getDigits(numOfControls) < 4) {
			for (int i = 0; i < 4 - getDigits(numOfControls); i++) {
				builder.append('0');
			}
		}
		builder.append(numOfControls + "-2");
		return builder.toString();
	}
	...
	public static String buildRouteTrailer(StringBuilder b) {
		...
		builder.append("T ");
		for (int i = 0; i < 6 - getDigits(numOfNonControls); i++) {
			builder.append('0');
		}
		builder.append(numOfNonControls + "-1 ");
	...
	public static String buildStations(int numberOfStations) {
		...
		for (int i = 1; i < numberOfStations + 1; i++) {
			...
			builder.append("Station" + i + " " + (Math.random() < .5 ? "F" : "P") + " " + Math.abs(onRange - onOffset)
	...
	public static String buildLocomotives(int numOfLocomotives, int numOfPassenger) {
		StringBuilder builder = new StringBuilder();
		builder.append("C LOCOMOTIVE " + numOfLocomotives + "\n");
	...
	public static String buildEdges(int numOfEdges) {
		StringBuilder builder = new StringBuilder();
		builder.append("C EDGE " + numOfEdges + "\n");
	...
	public static String buildMaintenence(int days, int maxNumEdges, int maxNumLocomotives, int maxNumStations) {
		...
		for (int i = 0; i < days; i++) {
			...
			for (int j = 0; j < numEdges; j++) {
				...
				builder.append(firstBuilding + " " + secondBuilding + " " + ((int) (Math.random() * InputGen.days)) + "\n");
